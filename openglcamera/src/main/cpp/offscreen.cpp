...
extern "C"
{
	JNIEXPORT void JNICALL Java_sen_com_openglcamera_offscreen_MyGles_init
	(JNIEnv*env,jobject obj);
	JNIEXPORT void JNICALL Java_sen_com_openglcamera_offscreen_MyGles_draw
	(JNIEnv*env,jobject obj);
	JNIEXPORT void JNICALL Java_sen_com_openglcamera_offscreen_MyGles_release
	(JNIEnv*env,jobject obj);
}
