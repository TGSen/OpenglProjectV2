...
import sen.com.openglcamera.CameraOldVersion;
import sen.com.openglcamera.CameraRenderer;
...
public class CameraSGLSurfaceView extends GLSurfaceView {
    ...
    public void init(CameraOldVersion mCamera, boolean isPreviewStarted, Activity mainActivity) {
